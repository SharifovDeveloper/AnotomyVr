...
Shader "RRF_HumanShaders/Skin Shaders/SimpleSSS/SimpleSSS6_DCM_SepAO"
{
	Properties
	{
		_Cutoff( "Mask Clip Value", Float ) = 0.5
		_CutoutMask1("CutoutMask1", Range( 0 , 2)) = 1
		_Mask1_Invert("Mask1_Invert", Range( 0 , 1)) = 0
		_OpacityMask1("OpacityMask1", 2D) = "white" {}
		_CutoutMask2("CutoutMask2", Range( 0 , 2)) = 1
		_Mask2_Invert("Mask2_Invert", Range( 0 , 1)) = 0
		_OpacityMask2("OpacityMask2", 2D) = "white" {}
		_MainLightTint("MainLightTint", Color) = (1,1,1,0)
		_Albedo_Tint("Albedo_Tint", Color) = (1,1,1,0)
		_Albedo("Albedo", 2D) = "white" {}
		_NormalMap("NormalMap", 2D) = "bump" {}
		[Header (AO is a separate texture)]_MetalGloss("Metal-Gloss", 2D) = "black" {}
	...
	SubShader
	{
		...
		uniform float _Mask1_Invert;
		uniform float _CutoutMask1;
		uniform sampler2D _OpacityMask2;
		uniform float4 _OpacityMask2_ST;
		uniform float _Mask2_Invert;
		uniform float _CutoutMask2;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 temp_cast_6 = (tex2D( _AOTexture, uv_AOTexture ).r).xxx;
			float temp_output_2_0_g9 = _AmbientOcclusion;
			...
			float3 AmbientOcclusion275 = ( ( temp_cast_6 * temp_output_2_0_g9 ) + appendResult7_g9 );
			o.Occlusion = AmbientOcclusion275.x;
			o.Alpha = 1;
			float2 uv_OpacityMask1 = i.uv_texcoord * _OpacityMask1_ST.xy + _OpacityMask1_ST.zw;
			float4 tex2DNode251 = tex2D( _OpacityMask1, uv_OpacityMask1 );
			float lerpResult266 = lerp( tex2DNode251.r , ( 1.0 - tex2DNode251.r ) , _Mask1_Invert);
			float2 uv_OpacityMask2 = i.uv_texcoord * _OpacityMask2_ST.xy + _OpacityMask2_ST.zw;
			float4 tex2DNode257 = tex2D( _OpacityMask2, uv_OpacityMask2 );
			float lerpResult269 = lerp( tex2DNode257.r , ( 1.0 - tex2DNode257.r ) , _Mask2_Invert);
			float clampResult260 = clamp( ( ( lerpResult266 * _CutoutMask1 ) + ( lerpResult269 * _CutoutMask2 ) ) , 0.0 , 1.0 );
			clip( clampResult260 - _Cutoff );
		}
...
/*ASEBEGIN
Version=18910
0;515.3334;1758;780;729.3135;1090.809;2.32254;True;False
Node;AmplifyShaderEditor.CommentaryNode;56;-1832.857,19.23205;Inherit;False;1435.461;680.1272;ScatterLight;13;29;30;32;35;40;39;37;44;114;117;133;115;193;;1,1,1,1;0;0
Node;AmplifyShaderEditor.PosVertexDataNode;29;-1782.857,346.5135;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldSpaceLightDirHlpNode;35;-1798.165,182.4451;Inherit;False;False;1;0;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.NormalVertexDataNode;191;-2044.716,18.31868;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TransformDirectionNode;30;-1516.109,325.217;Inherit;False;Object;World;False;Fast;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DotProductOpNode;193;-1447.417,58.50114;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;32;-1256.061,303.4789;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-1538.345,472.2159;Float;False;Property;_Light_Bias;Light_Bias;17;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;117;-1115.745,546.0661;Float;False;Property;_SSS_WeightAmount;SSS_WeightAmount;14;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;40;-1545.164,584.3593;Float;False;Property;_Light_Scale;Light_Scale;18;0;Create;True;0;0;0;False;0;False;0;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.DotProductOpNode;37;-1006.646,176.1735;Inherit;False;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;114;-1087.933,336.5719;Inherit;True;Property;_SSS_TextureWeightA;SSS_Texture-Weight(A);13;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;133;-712.0639,506.3657;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;38;-760.9614,705.5035;Inherit;False;ConstantBiasScale;-1;;8;63208df05c83e8e49a48ffbdce2e43a0;0;3;3;FLOAT;0;False;1;FLOAT;0.5;False;2;FLOAT;0.1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;115;-528.6672,247.3148;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ClampOpNode;131;-473.285,693.9008;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.CommentaryNode;58;-293.5292,-316.7261;Inherit;False;722.2638;725.0239;FuzzMix;4;45;130;33;62;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.SamplerNode;112;-1507.575,-1047.724;Inherit;True;Property;_Albedo;Albedo;9;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;45;-156.6521,194.803;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;51;-1471.425,-841.6143;Float;False;Property;_Albedo_Tint;Albedo_Tint;8;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LightColorNode;61;-1175.316,-228.1119;Inherit;False;0;3;COLOR;0;FLOAT3;1;FLOAT;2
Node;AmplifyShaderEditor.AbsOpNode;130;129.6605,200.4248;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;44;-840.3965,42.26363;Float;False;Property;_ScatterColor;ScatterColor;16;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;42;-1142.132,-567.6573;Float;False;Property;_MainLightTint;MainLightTint;7;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;33;211.0021,254.6402;Float;False;Property;_LightScatter;LightScatter;19;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;240;232.0033,100.2536;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;165;1750.598,-1740.372;Inherit;False;2639.649;1190.825;Dual Make up mixer (6-channel);20;150;148;149;143;154;155;156;151;152;153;144;157;158;159;145;160;161;162;163;164;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SamplerNode;143;1800.598,-1609.35;Inherit;True;Property;_MakeUpMask1_RGB;MakeUpMask1_RGB;26;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NegateNode;74;-19.58881,765.5759;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;148;2471.771,-1690.372;Float;False;Property;_Mask1_Rchannel_ColorAmountA;Mask1_Rchannel_Color-Amount(A);28;0;Create;True;0;0;0;False;0;False;0.7735849,0.2006942,0.3233189,0.7843137;0.7735849,0.2006942,0.3233189,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;149;2508.771,-1515.372;Float;False;Property;_Mask1_Gchannel_ColorAmountA;Mask1_Gchannel_Color-Amount(A);29;0;Create;True;0;0;0;False;0;False;0.2,0.772549,0.4917381,0.7843137;0.2,0.772549,0.4917381,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;154;2938.419,-1620.001;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;145;3360.889,-1652.063;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;150;2533.771,-1343.372;Float;False;Property;_Mask1_Bchannel_ColorAmountA;Mask1_Bchannel_Color-Amount(A);30;0;Create;True;0;0;0;False;0;False;0.2,0.406334,0.772549,0.7843137;0.2,0.406334,0.772549,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;155;2977.822,-1467.519;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;151;2480.521,-1103.547;Float;False;Property;_Mask2_Rchannel_ColorAmountA;Mask2_Rchannel_Color-Amount(A);31;0;Create;True;0;0;0;False;0;False;0.2,0.772549,0.7071339,0.7843137;0.2,0.772549,0.7071339,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;139;1264.742,800.3571;Float;False;Property;_MicroDetail_Tiling;MicroDetail_Tiling;22;0;Create;True;0;0;0;False;0;False;1;1;1;12;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;153;2542.521,-756.5474;Float;False;Property;_Mask2_Bchannel_ColorAmountA;Mask2_Bchannel_Color-Amount(A);33;0;Create;True;0;0;0;False;0;False;0.772549,0.7037676,0.2,0.7843137;0.772549,0.7037676,0.2,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.CommentaryNode;261;4592.011,218.1516;Inherit;False;1382.069;810.3781;Masking;14;259;249;269;266;256;260;251;267;268;265;262;258;250;257;;1,1,1,1;0;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;156;3005.234,-1299.617;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;87;345.288,969.9673;Float;False;Property;_BackScatterPower;BackScatterPower;20;0;Create;True;0;0;0;False;0;False;0;0;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;140;1278.675,919.4932;Float;False;Property;_MicroDetail_Offset;MicroDetail_Offset;23;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;152;2517.521,-928.5472;Float;False;Property;_Mask2_Gchannel_ColorAmountA;Mask2_Gchannel_Color-Amount(A);32;0;Create;True;0;0;0;False;0;False;0.772549,0.2,0.6776864,0.7843137;0.772549,0.2,0.6776864,0.7843137;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;173;3099.442,-55.58076;Float;False;Property;_GlossAdjust_Mask2Rchannel;GlossAdjust_Mask2-Rchannel;37;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;158;3036.074,-874.7222;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;174;3100.015,67.42487;Float;False;Property;_GlossAdjust_Mask2Gchannel;GlossAdjust_Mask2-Gchannel;38;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;157;3010.615,-1086.17;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;251;4656.611,203.9517;Inherit;True;Property;_OpacityMask1;OpacityMask1;3;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;257;4655.017,576.3628;Inherit;True;Property;_OpacityMask2;OpacityMask2;6;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;175;3097.648,179.0922;Float;False;Property;_GlossAdjust_Mask2Bchannel;GlossAdjust_Mask2-Bchannel;39;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;159;3067.207,-669.6664;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;169;3099.972,-253.1673;Float;False;Property;_GlossAdjust_Mask1Bchannel;GlossAdjust_Mask1-Bchannel;36;0;Create;True;0;0;0;False;0;False;-1;-1;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;171;3121.295,-432.9468;Float;False;Property;_GlossAdjust_Mask1Rchannel;GlossAdjust_Mask1-Rchannel;34;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;172;3112.004,-342.6861;Float;False;Property;_GlossAdjust_Mask1Gchannel;GlossAdjust_Mask1-Gchannel;35;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;141;1268.047,1031.532;Float;False;Property;_MicroDetail_Power;MicroDetail_Power;24;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;111;1912.566,370.4979;Inherit;True;Property;_NormalMap;NormalMap;10;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;267;4670.437,417.8569;Inherit;False;Property;_Mask1_Invert;Mask1_Invert;2;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;118;1555.486,-273.6144;Inherit;True;Property;_MetalGloss;Metal-Gloss;11;0;Create;True;0;0;0;False;1;Header (AO is a separate texture);False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;262;4951.619,336.4946;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;265;4963.435,567.2138;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;268;4692.037,938.6571;Inherit;False;Property;_Mask2_Invert;Mask2_Invert;5;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;137;1967.302,799.6944;Inherit;True;Property;_MicroDetailNormalMap;MicroDetail(NormalMap);21;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;59;1566.091,-49.84906;Float;False;Property;_SmoothnessDeviate;SmoothnessDeviate;12;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;108;1036.37,348.5114;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;138;1960.642,1015.33;Inherit;True;Property;_MicroDetail_WeightMapGreyscaleR;MicroDetail_WeightMap(Greyscale(R));25;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;278;2034.294,-502.2184;Inherit;True;Property;_AOTexture;AO Texture;42;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;266;5128.437,324.8569;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;258;4664.321,779.13;Inherit;False;Property;_CutoutMask2;CutoutMask2;4;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;250;4659.314,503.9187;Inherit;False;Property;_CutoutMask1;CutoutMask1;1;0;Create;True;0;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;274;2301.387,-307.4646;Inherit;False;Property;_AmbientOcclusion;AmbientOcclusion;41;0;Create;True;0;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;269;5144.437,710.8575;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;249;5306.392,369.0739;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;256;5321.327,710.6087;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;273;2349.405,-402.1005;Inherit;False;Lerp White To;-1;;9;047d7c189c36a62438973bad9d37b1c2;0;2;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;185;3522.607,987.2743;Float;False;Property;_FinalNormalMapPower;FinalNormalMapPower;40;0;Create;True;0;0;0;False;0;False;1;1;0;4;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;219;5154.535,-480.4781;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;243;2434.838,381.0009;Float;False;Property;_SSS_ToEmissive;SSS_ToEmissive;15;0;Create;True;0;0;0;False;0;False;0.1;0.1;0.1;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;271;2015.266,-205.2317;Inherit;False;metal;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;275;2697.129,-352.8659;Inherit;False;AmbientOcclusion;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;259;5477.279,552.3836;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;241;2765.912,230.3048;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;276;5680.474,-91.10172;Inherit;False;271;metal;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;260;5622.48,418.6829;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;277;5645.474,74.89828;Inherit;False;275;AmbientOcclusion;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;237;5194.235,-33.99472;Float;False;Gloss;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;246;5513.298,-454.8865;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
Node;AmplifyShaderEditor.NormalizeNode;188;4331.543,676.1862;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;21;6024.633,-40.72271;Float;False;True;-1;6;ASEMaterialInspector;0;0;Standard;RRF_HumanShaders/Skin Shaders/SimpleSSS/SimpleSSS6_DCM_SepAO;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;True;TransparentCutout;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
WireConnection;262;0;251;1
WireConnection;265;0;257;1
...
WireConnection;21;3;276;0
WireConnection;21;4;237;0
WireConnection;21;5;277;0
WireConnection;21;10;260;0
ASEEND*/
//CHKSM=5EA46D0C78CE4CF8626F4EAE0BDDBD9F269D70AF